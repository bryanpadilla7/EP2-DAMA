...
const ProfileScreenDoctor = () => {
    const [Nombre, setNombre] = useState('Dr. Bryan');
    const [Apellido, setApellido] = useState('Padilla');
    const [Especialidad, setEspecialidad] = useState('Pediatría');
    const [Mail, setMail] = useState('bryan.padilla@clinica.com');
    ...
    return(
        <View style={Styles.container}>
            ...
            <Pressable style={Styles.button}>
                <View style={Styles.row}>
                    <Ionicons name="fitness" size={25} color={'#2889D7'}></Ionicons>
                    <Text style={Styles.buttonText}>Especialidad: {Especialidad}</Text>
                </View>
            </Pressable>
...
export default ProfileScreenDoctor;